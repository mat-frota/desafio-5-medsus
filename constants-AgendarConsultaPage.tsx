...
export const UserCircleIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ChatBubblesIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M18.947 12.316C18.947 15.116 16.712 17.421 13.988 17.421H13.882C13.064 17.421 12.288 17.654 11.642 18.068L9.93199 19.295C9.44799 19.642 8.81399 19.336 8.81399 18.758V17.21C8.85599 16.915 8.74099 16.631 8.50999 16.442C7.10399 15.368 6.26299 13.789 6.26299 12.052C6.26299 8.27302 9.70299 5.26302 13.882 5.26302C16.891 5.26302 18.947 7.02002 18.947 9.80002" opacity="0.4" fill="currentColor"/>
      <path d="M17.7369 9.80017C17.7369 7.02017 15.6809 5.26318 13.1109 5.26318C9.09492 5.26318 5.65492 8.27318 5.65492 12.0528C5.65492 13.7898 6.49592 15.3688 7.90192 16.4428C8.13292 16.6318 8.24792 16.9158 8.20592 17.2108V18.7588C8.20592 19.3368 8.83992 19.6428 9.32392 19.2958L11.0349 18.0688C11.6809 17.6548 12.4569 17.4218 13.2749 17.4218H13.3809C15.9019 17.4218 17.7369 15.1168 17.7369 12.3168V9.80017Z" fill="currentColor"/>
    </svg>
  );
