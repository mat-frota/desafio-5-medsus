...
import { 
  ...
  ChatBubblesIcon,
  UserIcon
} from '../constants-AgendarConsultaPage.tsx';
import { Page } from '../App'; // Import Page for navigateTo prop
...
const AgendarConsultaPage: React.FC<AgendarConsultaPageProps> = ({ navigateTo }) => {
