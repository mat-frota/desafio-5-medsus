...
import Header from './Header2'; // LandingPage usa Header2
import Footer from './Footer';
import { HeartIconFilled } from '../constants-LandingPage.tsx'; 
...
interface LandingPageProps {
  ...
  onNavigateToInformacoesAdicionais: () => void;
  onNavigateToEspecialidades: () => void; // Added prop
  onNavigateToAgendarConsulta: () => void;
}
...
const LandingPage: React.FC<LandingPageProps> = ({ 
  ...
  onNavigateToInformacoesAdicionais,
  onNavigateToEspecialidades, // Destructure new prop
  onNavigateToAgendarConsulta
}) => {
  const features: FeatureItemProps[] = [
    { iconSrc: '/images/feature-icon-1.png', iconAlt: 'Ícone de calendário', title: 'Agendamento Fácil', description: 'Agende suas consultas de forma rápida e prática.' },
    { iconSrc: '/images/feature-icon-2.png', iconAlt: 'Ícone de relógio com notificações', title: 'Lembretes Automáticos', description: 'Receba notificações por Email e WhatsApp.' },
    { iconSrc: '/images/feature-icon-3.png', iconAlt: 'Ícone de escudo de segurança', title: 'Seguro e Confiável', description: 'Seus dados protegidos e com tecnologia de ponta.' },
  ];
  ...
  return (
    <div className="bg-slate-50 min-h-screen flex flex-col">
      <Header /> {/* Header2 não precisa de onNavigateToLanding, pois o logo já tem href="/" */}
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0 md:pr-10">
                ...
                <div className="mt-8 flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                  <a
                    href="#" 
                    onClick={(e) => { e.preventDefault(); onNavigateToAgendarConsulta();}} 
                  ...
                  <button
                    onClick={onNavigateToInformacoesAdicionais}
        ...
        <section className="py-16 lg:py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="flex flex-col md:flex-row justify-between items-center mb-10 lg:mb-12">
                ...
                <button
                  onClick={(e) => { e.preventDefault(); onNavigateToEspecialidades();}}
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                        <a
                        href="#"
                        onClick={(e) => { e.preventDefault(); alert('Navegar para Cadastro (não implementado)');}}
                        ...
                        <button
                        onClick={(e) => { e.preventDefault(); onNavigateToUserProfile();}}
