...
import { SearchIcon, HeartIconFilled, ChevronDownIcon } from '../constants-EspecialidadesPage.tsx';
...
const EspecialidadesPage: React.FC<EspecialidadesPageProps> = ({ onNavigateToLanding }) => {
  const specialties: SpecialtyCardProps[] = [
    { imageSrc: '/images/imagem-1.png', tag: 'Ginecologia', title: 'Bem-estar feminino', description: 'Saúde da mulher com atenção e cuidado integral.', imageAlt: 'Consulta de Ginecologia' },
    { imageSrc: '/images/imagem-2.png', tag: 'Pediatria', title: 'Cuidado com crianças', description: 'Especialistas dedicados à saúde infantil.', imageAlt: 'Consulta de Pediatria' },
    { imageSrc: '/images/imagem-3.png', tag: 'Cardiologia', title: 'Coração saudável', description: 'Acompanhamento para sua saúde cardiovascular.', imageAlt: 'Consulta de Cardiologia' },
    { imageSrc: '/images/imagem-4.png', tag: 'Dermatologia', title: 'Cuidado com sua pele', description: 'Soluções dermatológicas para saúde e estética.', imageAlt: 'Consulta de Dermatologia' },
    { imageSrc: '/images/imagem-5.png', tag: 'Neurologia', title: 'Saúde do cérebro', description: 'Diagnóstico e tratamento de distúrbios neurológicos.', imageAlt: 'Consulta de Neurologia' },
    { imageSrc: '/images/imagem-6.png', tag: 'Ortopedia', title: 'Movimentação', description: 'Tratamentos para ossos, músculos e articulações.', imageAlt: 'Consulta de Ortopedia' },
    { imageSrc: '/images/imagem-7.png', tag: 'Odontologia', title: 'Saúde bucal', description: 'Cuidados odontológicos para se manter saudável.', imageAlt: 'Consulta de Odontologia' },
    { imageSrc: '/images/imagem-8.png', tag: 'Oftalmologia', title: 'Visão em foco', description: 'Cuidados para manter sua saúde ocular em dia.', imageAlt: 'Consulta de Oftalmologia' },
    { imageSrc: '/images/imagem-9.png', tag: 'Endocrinologia', title: 'Equilíbrio hormonal', description: 'Acompanhamento de distúrbios hormonais.', imageAlt: 'Consulta de Endocrinologia' },
    { imageSrc: '/images/imagem-10.png', tag: 'Psiquiatria', title: 'Bem-estar mental', description: 'Atendimento especializado em saúde mental.', imageAlt: 'Consulta de Psiquiatria' },
    { imageSrc: '/images/imagem-11.png', tag: 'Gastroenterologia', title: 'Saúde digestiva', description: 'Cuidado com o sistema digestivo.', imageAlt: 'Consulta de Gastroenterologia' },
    { imageSrc: '/images/imagem-12.png', tag: 'Pneumologia', title: 'Respire melhor', description: 'Tratamentos para doenças respiratórias.', imageAlt: 'Consulta de Pneumologia' },
  ];
